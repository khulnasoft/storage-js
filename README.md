...
JS Client library to interact with Khulnasoft Storage.

- Documentation: https://khulnasoft.io/docs/reference/javascript/storage-createbucket
...
```bash
npm install @khulnasoft/storage-js
```

### Connecting to the storage backend

```js
import { StorageClient } from '@khulnasoft/storage-js'

const STORAGE_URL = 'https://<project_ref>.khulnasoft.co/storage/v1'
...
- Upload a file to an existing bucket:
  ...
  > Note: The `upload` method also accepts a map of optional parameters. For a complete list see the [Khulnasoft API reference](https://khulnasoft.com/docs/reference/javascript/storage-from-upload).
...
- List all the files within a bucket:
  ...
  > Note: The `list` method also accepts a map of optional parameters. For a complete list see the [Khulnasoft API reference](https://khulnasoft.com/docs/reference/javascript/storage-from-list).
